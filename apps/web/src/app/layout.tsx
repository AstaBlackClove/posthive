...
export const metadata: Metadata = {
  ...
  description: "Open-source social media scheduler for Bluesky, Threads, Instagram, LinkedIn, Mastodon, YouTube & more. Write once, post to multi platforms. Self-hostable.",
  keywords: [
