...
export const metadata: Metadata = {
  ...
  description: "Open-source social media scheduler for Bluesky, Threads, Instagram, LinkedIn, Mastodon, YouTube & more. Write once, post to 13 platforms. Self-hostable.",
  keywords: [
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Posthive — Open-source social media scheduler for 13 platforms",
      },
    ],
  },
  twitter: {
