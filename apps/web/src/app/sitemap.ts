...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/blog/best-social-media-scheduler`,               lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/blog/how-to-schedule-instagram-reels`,           lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/blog/canva-social-media-scheduler-alternative`,  lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    ...
    { url: `${base}/blog/how-to-schedule-first-comment-instagram`,     lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${base}/blog/storrito-alternative`,                        lastModified: now, changeFrequency: "monthly", priority: 0.7 },
    { url: `${base}/blog/open-source-social-media-scheduler`,          lastModified: now, changeFrequency: "monthly", priority: 0.8 },
