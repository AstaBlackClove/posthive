        ...
        <div className="rounded-2xl p-8" style={{ backgroundColor: "#111111", border: "1px solid #2a2a2a" }}>
          {sent ? (
            <div className="text-center">
              ...
              <h1 className="text-lg font-bold mb-2" style={{ color: "#ededed" }}>Check your email</h1>
              <p className="text-sm mb-6" style={{ color: "#888" }}>
                If <strong style={{ color: "#ededed" }}>{email}</strong> has an account, we&apos;ve sent a reset link. It expires in 1 hour.
              </p>
              <Link href="/login" className="text-sm font-semibold hover:opacity-80" style={{ color: "#5b63d3" }}>
                ← Back to login
              </Link>
            </div>
          ) : (
            <>
              <h1 className="text-lg font-bold mb-1" style={{ color: "#ededed" }}>Forgot password?</h1>
              <p className="text-sm mb-6" style={{ color: "#888" }}>
              ...
              <form onSubmit={submit} className="space-y-4">
                <div>
                  <label className="block text-xs font-medium mb-1.5" style={{ color: "#aaa" }}>Email</label>
                  <input
                    type="email"
                    value={email}
              ...
              <p className="text-center text-xs mt-5" style={{ color: "#555" }}>
                Remembered it?{" "}
                <Link href="/login" className="font-semibold hover:opacity-80" style={{ color: "#5b63d3" }}>
                  Log in
                </Link>
              </p>
            </>
